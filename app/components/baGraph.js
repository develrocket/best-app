...
export default class BAGraph extends Component {
    static propTypes = {
    ...
    renderGraph = () => {
        ...
        var upperTolerance = parseFloat(parseFloat(actual ? BevelAngle.upper : BevelAngle.upper - BevelAngle.nominal).toFixed(3));
        var lowerTolerance = parseFloat(parseFloat(actual ? BevelAngle.lower: BevelAngle.lower - BevelAngle.nominal).toFixed(3));
