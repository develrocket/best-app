...
export default class LTGraph extends Component {
    static propTypes = {
    ...
    renderGraph = () => {
        ...
        var upperTolerance = parseFloat(parseFloat(actual ? LandThickness.upper : LandThickness.upper - LandThickness.nominal).toFixed(3));
        var lowerTolerance = parseFloat(parseFloat(actual ? LandThickness.lower: LandThickness.lower - LandThickness.nominal).toFixed(3));
