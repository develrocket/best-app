...
export default class HBGraph extends Component {
    static propTypes = {
    ...
    renderGraph = () => {
        ...
        var upperTolerance = parseFloat(parseFloat(actual ? HalfBevelGap.upper : HalfBevelGap.upper - HalfBevelGap.nominal).toFixed(3));
        var lowerTolerance = parseFloat(parseFloat(actual ? HalfBevelGap.lower: HalfBevelGap.lower - HalfBevelGap.nominal).toFixed(3));
