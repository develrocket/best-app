...
export default class WTGraph extends Component {
    static propTypes = {
    ...
    renderGraph = () => {
        ...
        var upperTolerance = parseFloat(parseFloat(actual ? WallThickness.upper : WallThickness.upper - WallThickness.nominal).toFixed(3));
        var lowerTolerance = parseFloat(parseFloat(actual ? WallThickness.lower: WallThickness.lower - WallThickness.nominal).toFixed(3));
